...
- After taking bias (or acceptance boundary) into account:
    - Recall and recognition tasks estimated similar memory precision and probability of accesing the memory.
    - Shared representation for both recall and recognition.
    
- But the process is a harder question to answer.
