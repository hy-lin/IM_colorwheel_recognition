function trial = setupExpTrialInfo(visualInfo, expInfo)
...
for szInd = expInfo.setsize,
	...
	probeTypePool = [repmat(1, 1, round(expInfo.numberofExpTrialsPerBlock * expInfo.probeTypeRatio(1))) ...
		repmat(2, 1, round(expInfo.numberofExpTrialsPerBlock * expInfo.probeTypeRatio(2))) ...
		repmat(3, 1, round(expInfo.numberofExpTrialsPerBlock * expInfo.probeTypeRatio(3)))];
	...
	for repInd = 1:expInfo.numberofExpTrialsPerBlock,
		tInd = tInd + 1;
